...
namespace I2.Loc
{
    ...
    public partial class Localize : MonoBehaviour
    {
		...
		public void OnLocalize( bool Force = false )
		{
			...
			MainTranslation = (string.IsNullOrEmpty(FinalTerm) || FinalTerm=="-") ? null : LocalizationManager.GetTranslation (FinalTerm, false, addSheetPrefix:false);
			SecondaryTranslation = (string.IsNullOrEmpty(FinalSecondaryTerm) || FinalSecondaryTerm == "-") ? null : LocalizationManager.GetTranslation (FinalSecondaryTerm, false, addSheetPrefix: false);
