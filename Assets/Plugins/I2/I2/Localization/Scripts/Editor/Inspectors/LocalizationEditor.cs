...
namespace I2.Loc
{
	public abstract partial class LocalizationEditor : Editor
	{
		...
		SerializedProperty 	mProp_Assets, mProp_Languages, 
                            ...
                            mProp_Spreadsheet_LocalFileName, mProp_Spreadsheet_LocalCSVSeparator, mProp_CaseInsensitiveTerms, mProp_SheetPrefix, mProp_Spreadsheet_LocalCSVEncoding,
		...
		public void Custom_OnEnable( LanguageSourceData sourceData, SerializedProperty propSource)
		{
			...
			mProp_SheetPrefix                      = propSource.FindPropertyRelative("SheetPrefix");
